...
- [ ] Try passphrase `a`. Note the app accepts password with length 1
- [ ] Open Settings menu (triple dot in upper right). Note there are no backup
      options
- [ ] Enable option to ask for password each time the app is opened
- [ ] Close / open app
- [ ] Note it asks for password
- [ ] Scan QR code #2
- [ ] Uninstall / reintsall the app
