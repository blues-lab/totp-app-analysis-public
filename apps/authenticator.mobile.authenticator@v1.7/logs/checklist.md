...
- [ ] Download `authenticator.mobile.authenticator@v1.7` from from APKPure
      [here](https://apkpure.com/authenticator-mobile-authent/authenticator.mobile.authenticator/versions)
